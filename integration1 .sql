...
--
-- Hôte : 127.0.0.1
-- Généré le : sam. 09 mai 2026 à 13:29
...
--
-- Structure de la table `adoptionrequest`
--
...
--
-- Déchargement des données de la table `adoptionrequest`
--

INSERT INTO `adoptionrequest` (`id`, `animal_id`, `client_compte_id`, `message`, `phone`, `address`, `status`, `created_at`) VALUES
(1, 3, 15, NULL, NULL, NULL, 'REJECTED', '2026-04-17 09:08:00'),
(2, 3, 22, NULL, NULL, NULL, 'APPROVED', '2026-04-17 11:31:00');
...
(1, 1, 'hamza.benyahia@esprit.tn', '', 'ADMIN', 'ACTIVE'),
(2, 27, 'azizsalhi@gmail.com', '', 'VET', 'ACTIVE');
...
('DoctrineMigrations\\Version20260419113000', '2026-04-26 23:23:57', 129),
('DoctrineMigrations\\Version20260419121500', '2026-04-26 23:23:58', 62),
('DoctrineMigrations\\Version20260420100000', '2026-04-26 23:23:58', 73);
...
CREATE TABLE `face_credential` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `descriptor` longtext NOT NULL CHECK (json_valid(`descriptor`)),
...
(5, 1, '[-0.08135446533560753,0.06834266381338239,0.04497118527069688,-0.04282183479517698,-0.055437467992305756,-0.05307129630818963,-0.03886708623031154,0.003420772642130032,0.16036037355661392,-0.04076541354879737,0.1564982794225216,-0.037116716150194407,-0.24068090692162514,-0.026123224524781108,-0.056739731691777706,0.07326959259808064,-0.16693230718374252,-0.11104527674615383,-0.10742462426424026,-0.06083303410559893,0.09690786059945822,0.036358223063871264,0.006575599778443575,0.04057001555338502,-0.09784595854580402,-0.30941491574048996,-0.07467766758054495,-0.08846412412822247,0.022657287307083607,-0.11046157963573933,0.03701165039092302,0.016747425019275397,-0.17020155489444733,-0.047760050278156996,-0.012013263767585158,0.033512682653963566,-0.03050528420135379,-0.05149465799331665,0.17441031336784363,-0.01983989469590597,-0.16892894357442856,-0.0081451372243464,0.06320008262991905,0.23809102177619934,0.1894773691892624,0.1126965880393982,-0.05612111557275057,-0.015465261996723711,0.045181404799222946,-0.2853471711277962,0.05913212988525629,0.18165723979473114,0.11373111791908741,0.06656232103705406,0.1131124384701252,-0.19777556136250496,0.02471770136617124,0.13073373772203922,-0.19796742126345634,0.05946357315406203,-0.05276522692292929,-0.05609682761132717,0.016675977036356926,-0.04385692556388676,0.20660772919654846,0.09226668439805508,-0.10933085158467293,-0.07770195743069053,0.15520888566970825,-0.17609084770083427,-0.01848451077239588,0.08202722016721964,-0.08224558643996716,-0.19582923501729965,-0.24973979964852333,0.02465742570348084,0.4108903929591179,0.14305137284100056,-0.14281026646494865,0.05765693448483944,-0.06191812641918659,-0.0419586505740881,0.03217424638569355,0.011119530070573092,-0.15267289057374,-0.010106876026839018,-0.09324785321950912,0.016772932722233236,0.14372532814741135,0.02055131271481514,-0.05258798971772194,0.19534136354923248,-0.015345053281635046,0.012425745371729136,0.03906289301812649,-0.03247058717533946,-0.052662668109405786,-0.006409078778233379,-0.12398931570351124,5.836016498506069e-5,0.029984756838530302,-0.12964076735079288,-0.028161965310573578,0.07179092802107334,-0.16111831180751324,0.052549303392879665,0.03638585517182946,-0.05493261432275176,-0.040466240141540766,0.062368240440264344,-0.1441343566402793,-0.027035889914259315,0.18310002610087395,-0.2819737270474434,0.21849044412374496,0.18811355903744698,0.03884327947162092,0.17211458086967468,0.06854956527240574,0.06339128501713276,0.01331682177260518,-0.0421501100063324,-0.12670282274484634,-0.053252825513482094,0.052421551663428545,-0.02757997252047062,0.07715043553616852,0.05477081332355738]', 'Face Recognition', '2026-04-26 23:24:26', '2026-05-04 13:21:11');
...
--
-- Structure de la table `manager_account`
--
...
(45, 1, 4, 'support', NULL, NULL, 'Blocked account help request from adem ziri: i found my account blocked i am good user can you checks if you made erreur', 0, '2026-04-26 23:47:17'),
(46, 7, 4, 'support', NULL, NULL, 'Blocked account help request from adem ziri: i found my account blocked i am good user can you checks if you made erreur', 0, '2026-04-26 23:47:17'),
(47, 15, 4, 'support', NULL, NULL, 'Blocked account help request from adem ziri: i found my account blocked i am good user can you checks if you made erreur', 0, '2026-04-26 23:47:17'),
(48, 1, 4, 'support', NULL, NULL, 'Blocked account help request from adem ziri: hello i found my account blocked', 0, '2026-04-27 10:43:06'),
(49, 7, 4, 'support', NULL, NULL, 'Blocked account help request from adem ziri: hello i found my account blocked', 0, '2026-04-27 10:43:06'),
(50, 15, 4, 'support', NULL, NULL, 'Blocked account help request from adem ziri: hello i found my account blocked', 0, '2026-04-27 10:43:06'),
(51, 1, 4, 'support', NULL, NULL, 'Blocked account review for adem ziri | AI: Appel insuffisant pour une reactivation automatique. | Appeal: i tried to log in and i found my account unable to log in is there a way to help me out please', 0, '2026-04-27 15:44:39'),
(52, 7, 4, 'support', NULL, NULL, 'Blocked account review for adem ziri | AI: Appel insuffisant pour une reactivation automatique. | Appeal: i tried to log in and i found my account unable to log in is there a way to help me out please', 0, '2026-04-27 15:44:39'),
(53, 15, 4, 'support', NULL, NULL, 'Blocked account review for adem ziri | AI: Appel insuffisant pour une reactivation automatique. | Appeal: i tried to log in and i found my account unable to log in is there a way to help me out please', 0, '2026-04-27 15:44:39');
...
(2, 'ugv', 'medical', 55, 5, 'uploads/products/ugv-9f17338933ef.jpg', 'khyvhj', 54, 1),
...
(19, 'letsgooo2', 'medical', 55, 2, 'uploads/products/letsgooo-7ff2203983e3.jpg', 'letsgooo2 is a medical product that fits a care-oriented routine for pets that need reliable support items. azeaz The current visible price is 53.00 TND. It is currently available with 55 items in stock.', 56, 1),
...
(26, 'Pet Food Premium', 'medical', 25, 3, 'pet-food.png', 'Healthy dry food with balanced vitamins for daily nutrition.', 60, NULL),
(27, 'Interactive Pet Toy', 'medical', 18.5, 2, 'pet-toy.png', 'Soft, durable toy for playtime and mental stimulation.', 45, NULL),
(28, 'Comfort Carrier', 'medical', 72, 6, 'pet-carrier.png', 'Travel carrier with ventilation and reinforced frame.', 22, NULL),
(29, 'Medical Care Kit', 'medical', 39.9, 4.5, 'pet-medical.png', 'First-aid essentials for minor pet care emergencies.', 31, NULL),
(30, 'Accessory Pack', 'medical', 15, 1.5, 'pet-accessory.png', 'Leash, bowl, and grooming accessories in one pack.', 70, NULL);
...
CREATE TABLE `reservation` (
  ...
  `qr_code_generated_at` datetime DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(3, 'tVyHMZzmBH8gD5nfzUoz', 'lEfG9xdm+JLpU08F0/sFK2uP391pDgxo90Ze5r0qp2o=', '2026-05-09 10:43:04', '2026-05-09 11:43:04', 1);
...
INSERT INTO `review` (`id`, `note`, `commentaire`, `created_at`, `vet_id`, `client_id`, `rdv_id`, `rating`) VALUES
(1, 3, '', '2026-04-16 14:28:47', 14, 15, NULL, 3),
(2, 5, '', '2026-04-16 14:59:01', 18, 15, NULL, 5);
...
CREATE TABLE `user` (
  ...
  `voice_vector` longtext DEFAULT NULL CHECK (json_valid(`voice_vector`)),
...
INSERT INTO `user` (`id`, `first_name`, `last_name`, `email`, `password`, `phone`, `created_at`, `roles`, `phone_number`, `profile_image_url`, `is_verified`, `is_active`, `is_veteran_applicant`, `is_veteran_approved`, `updated_at`, `signature`, `voice_sample_path`, `voice_vector`, `voice_enrolled_at`, `voice_last_used_at`, `voice_passphrase`, `profile_image_path`, `id_user`, `name`, `role`) VALUES
(1, 'Hamzaa', 'Benyahia', 'hamza.benyahia@esprit.tn', '$2y$10$TuHxZ8L7E1YiUsDFiXqZtuWCerKkNwun5WxO8DRXPnckVbLQb2ywi', '53035155', '2026-02-14 10:16:04', '[\"ROLE_ADMIN\",\"ROLE_USER\"]', '53035155', 'uploads/profiles/WhatsApp-Image-2026-04-05-at-4-39-42-PM-69fdcec2ae79d.jpg', 1, 1, 0, 0, '2026-05-08 12:53:38', NULL, 'uploads/voice/voice-user-1-c500ac0e8de989f2.wav', NULL, '2026-04-26 23:36:55', '2026-04-29 20:21:11', 'test test test', NULL, 1, 'Hamzaa Benyahia', 'ADMIN'),
(2, 'hamza', 'benyahia', 'donniedarko@gmail.com', '$2y$13$e5J1.4e2Hj0MgWmXNhLVkugWAcouOnAHinB5jBSfv8Z9p6jO4xWAe', '53035155', '2026-02-14 12:14:14', '[\"ROLE_USER\"]', '53035155', NULL, 1, 1, 0, 0, '2026-04-04 20:26:39', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 'hamza benyahia', NULL),
(3, 'fzef', 'fzaazf', 'hjbhjazdf@gmail.com', '$2y$13$9GZ9Tvyp9d5OeEMmFrH2gu9857BpNbb40W9HFPKb1lE.VGgdzJuuC', '74852963', '2026-02-14 17:42:14', '[\"ROLE_USER\"]', '74852963', NULL, 1, 1, 0, 0, '2026-04-04 20:26:39', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 'fzef fzaazf', NULL),
(4, 'adem', 'ziri', 'ziriadem33@gmail.com', '$2y$13$2HV5SdwsJ5rp24ZS2Wt3XuXZbkc/UR1cAAEp9PGTjLACnrlWhPCiK', '53035155', '2026-02-15 12:09:08', '[\"ROLE_USER\"]', '27938446', NULL, 1, 0, 0, 0, '2026-04-26 23:44:16', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 'adem ziri', NULL),
(5, 'zakaria', 'zarouk', 'zarrouk.zakaria@esprit.tn', '$2y$13$Cphy8B/8LAmDbPvYX3sHSuG3gZjFXQBsk5gmYZNTrhJTRjY6i0e6W', '74859123', '2026-02-15 12:57:54', '[\"ROLE_USER\"]', '74859123', NULL, 1, 1, 0, 0, '2026-04-04 20:26:39', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 'zakaria zarouk', NULL),
(6, 'Safwen', 'Yahyaoui', 'safwenyahyaoui047@gmail.com', '$2y$13$bK9lMOLfaou.Lx24ARpoq.b.TKmymq.CgTjc0q2lsm6V55g9bcpLa', '0473821736', '2026-03-05 05:41:57', '[\"ROLE_USER\"]', '0473821736', 'C:\\Users\\safwe\\Desktop\\equipe\\saf.jpeg', 1, 1, 0, 0, '2026-04-04 20:26:39', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 'Safwen Yahyaoui', NULL),
(7, 'Zakaria', 'Zarrouk', 'zakaria.zarrouk@esprit.tn', '$2y$13$v0m5DNnI2EXeTKzUbp0YK.FF2sFzSkZZ3cPcMAQe.r8rz6NNsgYPu', '0473821738', '2026-03-05 11:14:33', '[\"ROLE_ADMIN\", \"ROLE_USER\"]', '0473821738', 'C:\\Users\\safwe\\Desktop\\equipe\\zak.jpeg', 1, 1, 0, 0, '2026-04-04 20:26:39', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 'Zakaria Zarrouk', NULL),
(8, 'Youssef', 'Tounsi', 'youssef.tounsi@esprit.tn', '$2y$13$xtnmZEuZuSUyZVcNGsuXR.dVKXp0G3VcAEMOF75zxAl6h87dGuF6q', '0473821739', '2026-03-05 11:14:33', '[\"ROLE_USER\"]', '0473821739', 'C:\\Users\\safwe\\Desktop\\equipe\\youssef.jpeg', 1, 1, 0, 0, '2026-04-04 20:26:39', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 'Youssef Tounsi', NULL),
(9, 'Joumena', 'Turki', 'joumena.turki@esprit.tn', '$2y$13$.hzj1GuXTv9tTK/oaJhTYuxmX3KJwk8L6prA/uIWg0t68dOaBDcMu', '0473821740', '2026-03-05 11:14:33', '[\"ROLE_USER\"]', '0473821740', 'C:\\Users\\safwe\\Desktop\\equipe\\djo.jpeg', 1, 1, 0, 0, '2026-04-04 20:26:39', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, 'Joumena Turki', NULL),
(10, 'Ilef', 'Ben Chouchane', 'ilef.benchouchane@esprit.tn', '$2y$13$CCX.YvSt4TYWiJDrsk6gSuW.5hF.QzcQVebUyXXvsBW1JCPQe1Shi', '0473821741', '2026-03-05 11:14:33', '[\"ROLE_USER\"]', '0473821741', 'C:\\Users\\safwe\\Desktop\\equipe\\ilef.jpeg', 1, 1, 0, 0, '2026-04-04 20:26:39', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 'Ilef Ben Chouchane', NULL),
(11, 'youssef', 'tounsi', 'youssef.tounsi@gmail.com', '$2y$13$z7YR0XXk1CXtxjyRyoeyD.Qd4nr3qjt3BSeFf9yUxUBwCKTfEQVJe', NULL, '2026-04-04 18:52:30', '[]', '15478596', 'uploads/profiles/cv-69d151453da95.png', 0, 1, 0, 0, '2026-04-04 19:58:29', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 11, 'youssef tounsi', NULL),
(14, 'ilef', 'ben chouchen', 'ilefbenchouchane3@gmail.com', '$2y$13$JF8YgsnGwbSicTssaERsFuSpepFB0xzUQq7rTogqY/jtYRSzOKgLa', NULL, '2026-04-16 01:58:48', '[\"ROLE_USER\",\"ROLE_VETERINAIRE\"]', '95309296', NULL, 1, 1, 1, 1, '2026-04-16 20:51:43', '{\"version\":1,\"points\":[{\"x\":-0.176051,\"y\":-0.46304},{\"x\":-0.113595,\"y\":-0.440253},{\"x\":-0.051133,\"y\":-0.417484},{\"x\":0.011804,\"y\":-0.396059},{\"x\":0.070963,\"y\":-0.366168},{\"x\":0.128946,\"y\":-0.333641},{\"x\":0.185737,\"y\":-0.299191},{\"x\":0.240685,\"y\":-0.261763},{\"x\":0.296505,\"y\":-0.225745},{\"x\":0.353718,\"y\":-0.192117},{\"x\":0.404196,\"y\":-0.14885},{\"x\":0.446776,\"y\":-0.100541},{\"x\":0.467936,\"y\":-0.037646},{\"x\":0.490882,\"y\":0.024624},{\"x\":0.490873,\"y\":0.088887},{\"x\":0.470373,\"y\":0.151956},{\"x\":0.452039,\"y\":0.215731},{\"x\":0.416536,\"y\":0.27022},{\"x\":0.375689,\"y\":0.32249},{\"x\":0.339995,\"y\":0.378579},{\"x\":0.299183,\"y\":0.430876},{\"x\":0.255916,\"y\":0.481353},{\"x\":0.203707,\"y\":0.522032},{\"x\":0.13913,\"y\":0.531861},{\"x\":0.072843,\"y\":0.53696},{\"x\":0.013914,\"y\":0.508717},{\"x\":-0.046583,\"y\":0.481408},{\"x\":-0.102997,\"y\":0.447872},{\"x\":-0.156067,\"y\":0.408856},{\"x\":-0.213832,\"y\":0.379695},{\"x\":-0.26431,\"y\":0.336428},{\"x\":-0.303719,\"y\":0.283062},{\"x\":-0.338078,\"y\":0.226153},{\"x\":-0.372284,\"y\":0.169144},{\"x\":-0.394188,\"y\":0.106829},{\"x\":-0.400305,\"y\":0.040722},{\"x\":-0.432564,\"y\":-0.013789},{\"x\":-0.434128,\"y\":-0.079054},{\"x\":-0.436531,\"y\":-0.145282},{\"x\":-0.437082,\"y\":-0.210858},{\"x\":-0.411998,\"y\":-0.272428},{\"x\":-0.38375,\"y\":-0.332565},{\"x\":-0.344241,\"y\":-0.385537},{\"x\":-0.290885,\"y\":-0.422187},{\"x\":-0.229606,\"y\":-0.447947},{\"x\":-0.163559,\"y\":-0.442084},{\"x\":-0.097271,\"y\":-0.447183},{\"x\":-0.03359,\"y\":-0.46304}]}', NULL, NULL, NULL, NULL, NULL, NULL, 14, 'ilef ben chouchen', NULL),
(15, 'Admin', 'User', 'admin@furhope.com', '$2y$13$nO0./cEwFRB6Y/y5Kz9oA.j6069KgV4KhY3Hbax3j9WSqap7C2OVm', '+21695309296', '2026-04-16 02:01:02', '[\"ROLE_ADMIN\"]', '+21695309296', NULL, 1, 1, 0, 0, '2026-04-16 13:57:30', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 15, 'Admin User', NULL),
(16, 'Chak', 'chouka', 'ilefbenchouchane@gmail.com', '$2y$13$6Wp.XAuczTHMpk.mK6pYBuei65EX2Af9MCLZrmD.kiPu0kj0tZIfW', NULL, '2026-04-16 02:43:11', '[\"ROLE_USER\"]', NULL, NULL, 1, 1, 0, 0, '2026-04-30 10:10:05', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 16, 'Chak chouka', NULL),
(17, 'mohamed', 'ahmed', 'mohamed@gmail.com', '$2y$13$O5mD4DFWi4W2tqpgwHgHaujAoTKE/oSSPnC66BGBgnZo1oFSbrlHe', NULL, '2026-04-16 14:30:13', '[\"ROLE_USER\",\"ROLE_VETERINAIRE\"]', NULL, NULL, 1, 1, 1, 1, '2026-04-16 14:37:08', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 17, 'mohamed ahmed', NULL),
(18, 'halima', 'ha', 'halima@gmail.com', '$2y$13$ifrrgrAPOF0Y.2/z4C27y.AVJSFxsQnG9TjCmKHo.RamkjNXCpiYu', NULL, '2026-04-16 14:51:03', '[\"ROLE_USER\",\"ROLE_VETERINAIRE\"]', NULL, NULL, 1, 1, 1, 1, '2026-04-16 14:54:32', '{\"version\":1,\"points\":[{\"x\":0.05419,\"y\":-0.428698},{\"x\":0.072518,\"y\":-0.419534},{\"x\":0.059004,\"y\":-0.426291},{\"x\":0.128814,\"y\":-0.410632},{\"x\":0.185229,\"y\":-0.370229},{\"x\":0.246103,\"y\":-0.332741},{\"x\":0.31407,\"y\":-0.31466},{\"x\":0.380795,\"y\":-0.291313},{\"x\":0.445404,\"y\":-0.259009},{\"x\":0.487037,\"y\":-0.205845},{\"x\":0.478874,\"y\":-0.13952},{\"x\":0.472484,\"y\":-0.073069},{\"x\":0.4598,\"y\":-0.002331},{\"x\":0.453473,\"y\":0.068625},{\"x\":0.421168,\"y\":0.133234},{\"x\":0.388863,\"y\":0.197844},{\"x\":0.376139,\"y\":0.26533},{\"x\":0.328384,\"y\":0.318803},{\"x\":0.279802,\"y\":0.368015},{\"x\":0.218948,\"y\":0.406691},{\"x\":0.154065,\"y\":0.436492},{\"x\":0.083292,\"y\":0.434448},{\"x\":0.036876,\"y\":0.47324},{\"x\":-0.03536,\"y\":0.47324},{\"x\":-0.107595,\"y\":0.47324},{\"x\":-0.172636,\"y\":0.442763},{\"x\":-0.237246,\"y\":0.410458},{\"x\":-0.292424,\"y\":0.365068},{\"x\":-0.282633,\"y\":0.348977},{\"x\":-0.308738,\"y\":0.348728},{\"x\":-0.352079,\"y\":0.29094},{\"x\":-0.407472,\"y\":0.247592},{\"x\":-0.453797,\"y\":0.203987},{\"x\":-0.474061,\"y\":0.137133},{\"x\":-0.512963,\"y\":0.076427},{\"x\":-0.504053,\"y\":0.013927},{\"x\":-0.471748,\"y\":-0.050682},{\"x\":-0.439443,\"y\":-0.115291},{\"x\":-0.407139,\"y\":-0.179901},{\"x\":-0.367664,\"y\":-0.236244},{\"x\":-0.309649,\"y\":-0.271209},{\"x\":-0.251453,\"y\":-0.293925},{\"x\":-0.189585,\"y\":-0.325027},{\"x\":-0.117349,\"y\":-0.325027},{\"x\":-0.045114,\"y\":-0.325027},{\"x\":0.022169,\"y\":-0.339887},{\"x\":0.086673,\"y\":-0.370411},{\"x\":0.106026,\"y\":-0.428698}]}', NULL, NULL, NULL, NULL, NULL, NULL, 18, 'halima ha', NULL),
(19, 'ilef', 'ilef', 'ilef@gmail.com', '$2y$13$K85/W1FvYRWzNRpLihvxS.Hj326YQXDV4TRYQSGaaUDBjUiCO2iSq', NULL, '2026-04-16 17:27:33', '[\"ROLE_USER\",\"ROLE_VETERINAIRE\"]', NULL, NULL, 1, 1, 1, 1, '2026-05-02 19:24:34', '{\"version\":1,\"points\":[{\"x\":-0.530555,\"y\":-0.244662},{\"x\":-0.278735,\"y\":-0.2119},{\"x\":-0.238789,\"y\":0.064378},{\"x\":-0.432426,\"y\":0.192685},{\"x\":-0.271472,\"y\":-0.053346},{\"x\":-0.202669,\"y\":0.17634},{\"x\":-0.199227,\"y\":0.059366},{\"x\":-0.064204,\"y\":0.205105},{\"x\":-0.169253,\"y\":0.00148},{\"x\":-0.179503,\"y\":-0.257515},{\"x\":-0.113757,\"y\":-0.322135},{\"x\":-0.101709,\"y\":-0.147133},{\"x\":-0.298921,\"y\":-0.336318},{\"x\":-0.128146,\"y\":-0.51728},{\"x\":0.112564,\"y\":-0.438393},{\"x\":0.184708,\"y\":-0.29228},{\"x\":0.106944,\"y\":-0.072255},{\"x\":-0.139075,\"y\":-0.099144},{\"x\":-0.091373,\"y\":-0.290131},{\"x\":0.145275,\"y\":-0.198215},{\"x\":0.068975,\"y\":0.02099},{\"x\":-0.016612,\"y\":0.147377},{\"x\":0.097694,\"y\":0.399583},{\"x\":0.257868,\"y\":0.437762},{\"x\":0.298912,\"y\":0.398558},{\"x\":0.275016,\"y\":0.335905},{\"x\":0.263733,\"y\":0.197126},{\"x\":0.150337,\"y\":-0.026836},{\"x\":0.273646,\"y\":-0.149173},{\"x\":0.406393,\"y\":0.007526},{\"x\":0.469445,\"y\":0.247146},{\"x\":0.223569,\"y\":0.302789},{\"x\":-0.017636,\"y\":0.397492},{\"x\":-0.024015,\"y\":0.085189},{\"x\":0.199741,\"y\":-0.026072},{\"x\":0.250561,\"y\":-0.116813},{\"x\":-0.020382,\"y\":-0.214524},{\"x\":0.088395,\"y\":-0.113803},{\"x\":0.288826,\"y\":-0.134414},{\"x\":0.311548,\"y\":0.037643},{\"x\":0.100483,\"y\":0.120259},{\"x\":-0.114203,\"y\":0.300349},{\"x\":-0.241601,\"y\":0.089124},{\"x\":-0.033975,\"y\":-0.041764},{\"x\":0.047218,\"y\":0.227945},{\"x\":-0.246689,\"y\":0.190975},{\"x\":-0.31788,\"y\":-0.094323},{\"x\":-0.149044,\"y\":-0.244662}]}', NULL, NULL, NULL, NULL, NULL, NULL, 19, 'ilef ilef', NULL),
(20, 'bata', 'batout', 'bata@gmail.com', '$2y$13$LjJCU1WBChfWKc.mSUgB/.TMrbP/z/BotlLsRQwvfOPy4595miqnq', NULL, '2026-04-16 20:25:33', '[\"ROLE_USER\",\"ROLE_VETERINAIRE\"]', NULL, NULL, 1, 1, 1, 1, '2026-04-30 10:10:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 20, 'bata batout', NULL),
(22, 'joumana', 'turki', 'joumenaturki@gmail.com', '$2y$13$VYEcRfyiF8ZfLrmZ0Os1ourdd7wjeteRE5iKId.iQdZl5R1c79ReC', NULL, '2026-04-17 00:04:02', '[\"ROLE_USER\"]', NULL, NULL, 1, 1, 0, 0, '2026-04-30 10:09:55', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 22, 'joumana turki', NULL),
(23, 'batata', 'hlowa', 'batata.hlawa@gmail.com', '$2y$13$t8EyfE.WmF9OcZ0WNSftb.11S3ytcGl.WvIvnWuQQHEn/MB1e.fDy', NULL, '2026-04-17 12:35:57', '[\"ROLE_USER\"]', NULL, NULL, 1, 1, 0, 0, '2026-04-30 10:09:53', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 23, 'batata hlowa', NULL),
(27, 'aziz', 'salhi', 'azizsalhi@gmail.com', '$2a$12$quL/SJFH5IKX2dA09.EIoeTT7k6u1HRS9NJYP/PdKckWnrUW9n7EC', '53035155', '2026-05-08 13:09:42', '[\"ROLE_USER\",\"ROLE_VETERINAIRE\"]', '53035155', NULL, 1, 0, 1, 1, '2026-05-08 20:17:55', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 27, 'aziz salhi', NULL);
...
--
-- Index pour la table `adoptionrequest`
--
...
--
-- Index pour la table `manager_account`
--
...
ALTER TABLE `rendezvous`
  ...
  ADD KEY `idx_rendezvous_client` (`client_id`),
  ADD KEY `idx_rendezvous_vet` (`vet_id`),
  ADD KEY `idx_rendezvous_animal` (`animal_id`),
  ADD KEY `idx_rendezvous_disponibilite` (`disponibilite_id`);
...
--
-- AUTO_INCREMENT pour la table `adoptionrequest`
--
ALTER TABLE `adoptionrequest`
...
--
-- AUTO_INCREMENT pour la table `manager_account`
--
ALTER TABLE `manager_account`
