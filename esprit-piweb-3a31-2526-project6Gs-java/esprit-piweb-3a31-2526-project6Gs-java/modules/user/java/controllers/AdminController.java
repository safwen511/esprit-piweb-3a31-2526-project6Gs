...
public class AdminController {
    ...
    private void refreshTable() {
        try {
            ...
            e.printStackTrace();
            showAlert(Alert.AlertType.ERROR, "Error", "Could not load pending users: " + rootCauseMessage(e));
        }
    }
    ...
    private void switchScene(ActionEvent event, String fxmlFile) {
        try {
            ...
            e.printStackTrace();
            showAlert(Alert.AlertType.ERROR, "System Error", "Unable to open page: " + rootCauseMessage(e));
        }
    }
