...
public final class  SendGridEmailSender {
    ...
    public static void sendEmail(String toEmail, String subject, String textBody) {
        ...
        try {
            ...
            throw new RuntimeException("Failed to send Brevo email reset code.", e);
        }
    }
    ...
    private static Properties loadAppProperties() {
        ...
        loadOptionalFile(properties, "../../.env");
        loadOptionalFile(properties, "../../.env.local");
        loadOptionalFile(properties, "esprit-piweb-3a31-2526-project6Gs-java/esprit-piweb-3a31-2526-project6Gs-java/infrastructure/secrets/mail.secrets.properties");
