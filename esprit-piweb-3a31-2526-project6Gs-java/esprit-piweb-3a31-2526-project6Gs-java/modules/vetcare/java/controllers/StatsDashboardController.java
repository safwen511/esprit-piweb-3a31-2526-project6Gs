    ...
    private void loadDashboard() {
        try {
            ...
            PreparedStatement ps1 = conn.prepareStatement(
                    "SELECT DATE(created_at) as jour, AVG(COALESCE(note, rating)) as moyenne " +
            ...
            PreparedStatement ps2 = conn.prepareStatement(
                    "SELECT u.first_name, AVG(COALESCE(rv.note, rv.rating)) as moyenne " +
            ...
            PreparedStatement ps3 = conn.prepareStatement(
                    "SELECT AVG(COALESCE(note, rating)) as moy, COUNT(*) as nb FROM review WHERE vet_id = ?"
            );
            ps3.setInt(1, vetId);
        ...
        CompletableFuture.runAsync(() -> {
            try {
                ...
                PreparedStatement ps = conn.prepareStatement(
                        "SELECT COALESCE(note, rating) AS rating, commentaire FROM review WHERE vet_id = ?"
                );
                ps.setInt(1, vetId);
