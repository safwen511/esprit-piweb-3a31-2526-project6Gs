 ...
 */
class getCommentReactionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CommentReactionRepository' shared autowired service.
     *
     * @return \App\Repository\CommentReactionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CommentReactionRepository.php';

        return $container->privates['App\\Repository\\CommentReactionRepository'] = new \App\Repository\CommentReactionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
