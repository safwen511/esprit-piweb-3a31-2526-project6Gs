 ...
 */
class getPostShareRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PostShareRepository' shared autowired service.
     *
     * @return \App\Repository\PostShareRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PostShareRepository.php';

        return $container->privates['App\\Repository\\PostShareRepository'] = new \App\Repository\PostShareRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
