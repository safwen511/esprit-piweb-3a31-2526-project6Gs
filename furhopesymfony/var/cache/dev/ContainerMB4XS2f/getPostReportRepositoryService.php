 ...
 */
class getPostReportRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PostReportRepository' shared autowired service.
     *
     * @return \App\Repository\PostReportRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PostReportRepository.php';

        return $container->privates['App\\Repository\\PostReportRepository'] = new \App\Repository\PostReportRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
