...
class getDebug_Security_EventDispatcher_ApiLoginService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [#[\Closure(name: 'security.listener.api_login.user_provider', class: 'Symfony\\Component\\Security\\Http\\EventListener\\UserProviderListener')] fn () => ($container->privates['security.listener.api_login.user_provider'] ?? $container->load('getSecurity_Listener_ApiLogin_UserProviderService')), 'checkPassport'], 2048);
