...
class getHomeControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.BPfedfJ'] ?? $container->load('get_ServiceLocator_BPfedfJService'))->withContext('App\\Controller\\HomeController', $container));
