...
class ResetPasswordController extends AbstractController
{
    ...
    public function request(
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $channel = (string) $form->get('channel')->getData();
            ...
            if ($user instanceof User) {
                ...
                $this->processSendingPasswordReset($user, $channel, $resetPasswordHelper, $notifier);
            } else {
    ...
    private function processSendingPasswordReset(
        User $user,
        string $channel,
        ResetPasswordHelperInterface $resetPasswordHelper,
        PasswordResetNotifier $notifier,
        ...
        $notifier->sendEmail($user, $resetUrl, $expiresInMinutes);
    }
