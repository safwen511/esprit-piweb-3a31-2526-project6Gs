 ...
 */
final class Version20260404165337 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE body body LONGTEXT NOT NULL, CHANGE status status VARCHAR(10) DEFAULT \'ACTIVE\' NOT NULL, CHANGE created_at created_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE friend_request CHANGE status status VARCHAR(16) DEFAULT \'PENDING\' NOT NULL, CHANGE created_at created_at DATETIME NOT NULL');
        $this->addSql('DROP INDEX uq_friendship_pair ON friendship');
        $this->addSql('ALTER TABLE friendship CHANGE created_at created_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE notification CHANGE type type VARCHAR(20) NOT NULL, CHANGE created_at created_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE post DROP FOREIGN KEY `post_ibfk_1`');
        $this->addSql('ALTER TABLE post CHANGE caption caption LONGTEXT DEFAULT NULL, CHANGE media_type media_type VARCHAR(10) DEFAULT \'NONE\' NOT NULL, CHANGE visibility visibility VARCHAR(10) DEFAULT \'PUBLIC\' NOT NULL, CHANGE status status VARCHAR(10) DEFAULT \'ACTIVE\' NOT NULL, CHANGE created_at created_at DATETIME NOT NULL');
        ...
        $this->addSql('ALTER TABLE post_reaction CHANGE reaction reaction VARCHAR(16) NOT NULL, CHANGE created_at created_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE post_report CHANGE created_at created_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE post_share CHANGE created_at created_at DATETIME NOT NULL');
        $this->addSql('DROP INDEX id_user ON user');
        $this->addSql('ALTER TABLE user ADD roles JSON NOT NULL, ADD phone_number VARCHAR(30) DEFAULT NULL, ADD is_verified TINYINT NOT NULL, ADD is_active TINYINT NOT NULL, ADD is_veteran_applicant TINYINT NOT NULL, ADD is_veteran_approved TINYINT NOT NULL, ADD updated_at DATETIME NOT NULL, DROP phone, DROP city, DROP role, DROP active, DROP id_user, DROP name, DROP profile_image_path, CHANGE first_name first_name VARCHAR(120) NOT NULL, CHANGE last_name last_name VARCHAR(120) NOT NULL, CHANGE email email VARCHAR(180) NOT NULL, CHANGE created_at created_at DATETIME NOT NULL, CHANGE address profile_image_url VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE hotel (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, address VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, manager_id INT DEFAULT NULL, capacity INT NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, INDEX fk_hotel_manager (manager_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, category VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT \'medical\' NOT NULL COLLATE `utf8mb4_general_ci`, price DOUBLE PRECISION NOT NULL, tva DOUBLE PRECISION NOT NULL, image VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, description TEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, stock INT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, animal_id INT DEFAULT NULL, hotel_id INT DEFAULT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, status VARCHAR(16) CHARACTER SET utf8mb4 DEFAULT \'PENDING\' NOT NULL COLLATE `utf8mb4_general_ci`, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, reservation_date DATE NOT NULL, guest_count INT DEFAULT 1 NOT NULL, nightly_rate NUMERIC(10, 2) DEFAULT \'85.00\' NOT NULL, total_price NUMERIC(10, 2) DEFAULT \'85.00\' NOT NULL, INDEX fk_reservation_client (client_id), INDEX fk_reservation_animal (animal_id), INDEX fk_reservation_hotel (hotel_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE review (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, vet_id INT NOT NULL, rdv_id INT NOT NULL, rating INT NOT NULL, commentaire TEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, INDEX idx_review_vet (vet_id), INDEX idx_review_rdv (rdv_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE comment CHANGE body body TEXT NOT NULL, CHANGE status status ENUM(\'ACTIVE\', \'HIDDEN\', \'DELETED\') DEFAULT \'ACTIVE\' NOT NULL, CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
        $this->addSql('ALTER TABLE friendship CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
        $this->addSql('CREATE UNIQUE INDEX uq_friendship_pair ON friendship (user1_id, user2_id)');
        $this->addSql('ALTER TABLE friend_request CHANGE status status ENUM(\'PENDING\', \'ACCEPTED\', \'DECLINED\', \'CANCELLED\') DEFAULT \'PENDING\' NOT NULL, CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
        $this->addSql('ALTER TABLE notification CHANGE type type ENUM(\'POST_LIKE\', \'POST_DISLIKE\', \'POST_COMMENT\', \'COMMENT_REPLY\', \'COMMENT_LIKE\') NOT NULL, CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
        $this->addSql('ALTER TABLE post DROP FOREIGN KEY FK_5A8A6C8DF675F31B');
        $this->addSql('ALTER TABLE post CHANGE caption caption TEXT DEFAULT NULL, CHANGE media_type media_type ENUM(\'NONE\', \'IMAGE\', \'VIDEO\') DEFAULT \'NONE\' NOT NULL, CHANGE visibility visibility ENUM(\'PUBLIC\', \'FRIENDS\', \'PRIVATE\') DEFAULT \'PUBLIC\' NOT NULL, CHANGE status status ENUM(\'ACTIVE\', \'HIDDEN\', \'DELETED\') DEFAULT \'ACTIVE\' NOT NULL, CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
        ...
        $this->addSql('ALTER TABLE post_reaction CHANGE reaction reaction ENUM(\'LIKE\', \'DISLIKE\') NOT NULL, CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
        $this->addSql('ALTER TABLE post_report CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
        $this->addSql('ALTER TABLE post_share CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
        $this->addSql('ALTER TABLE `user` ADD phone VARCHAR(20) DEFAULT NULL, ADD city VARCHAR(100) DEFAULT NULL, ADD role VARCHAR(20) DEFAULT NULL, ADD active TINYINT DEFAULT 1, ADD id_user INT DEFAULT NULL, ADD name VARCHAR(150) DEFAULT NULL, ADD profile_image_path VARCHAR(1024) DEFAULT NULL, DROP roles, DROP phone_number, DROP is_verified, DROP is_active, DROP is_veteran_applicant, DROP is_veteran_approved, DROP updated_at, CHANGE email email VARCHAR(150) NOT NULL, CHANGE first_name first_name VARCHAR(100) NOT NULL, CHANGE last_name last_name VARCHAR(100) NOT NULL, CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE profile_image_url address VARCHAR(255) DEFAULT NULL');
        $this->addSql('CREATE UNIQUE INDEX id_user ON `user` (id_user)');
