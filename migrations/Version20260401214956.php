 ...
 */
final class Version20260401214956 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE panier (id INT AUTO_INCREMENT NOT NULL, idProduit INT NOT NULL, title VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, totalP DOUBLE PRECISION NOT NULL, totalt DOUBLE PRECISION NOT NULL, qty INT NOT NULL, client_id INT NOT NULL, INDEX fk_panier_client (client_id), INDEX idProduit (idProduit), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
